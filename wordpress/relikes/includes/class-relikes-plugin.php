			...
			<form method="post" action="options.php">
				...
				<div class="rlkwp-layout">
					...
					<section class="rlkwp-card rlkwp-card--wide"><div class="rlkwp-card__heading"><span>3</span><div><h2><?php esc_html_e( 'Selection brush', 'relikes' ); ?></h2><p><?php esc_html_e( 'These Clean Selection visuals apply while a reader is choosing a passage.', 'relikes' ); ?></p></div></div><div class="rlkwp-field-grid">
						...
						<?php $this->render_number_field( $settings, 'brush_hardness', __( 'Hardness', 'relikes' ), 0.05, 0.85, 0.01 ); ?><?php $this->render_number_field( $settings, 'brush_max_alpha', __( 'In-progress opacity', 'relikes' ), 0.05, 0.4, 0.01 ); ?><?php $this->render_number_field( $settings, 'brush_spacing', __( 'Stamp spacing', 'relikes' ), 0.15, 0.75, 0.01 ); ?><?php $this->render_number_field( $settings, 'brush_turbulence', __( 'Turbulence', 'relikes' ), 0, 0.6, 0.01 ); ?><?php $this->render_number_field( $settings, 'brush_turbulence_speed', __( 'Turbulence speed', 'relikes' ), 0.1, 1.2, 0.01 ); ?><?php $this->render_number_field( $settings, 'brush_final_alpha', __( 'Final selection opacity', 'relikes' ), 0.1, 0.6, 0.01 ); ?><?php $this->render_number_field( $settings, 'brush_fade_speed', __( 'Fog fade speed', 'relikes' ), 0.001, 0.08, 0.001 ); ?><?php $this->render_number_field( $settings, 'brush_grow_speed', __( 'Cloud grow speed', 'relikes' ), 0.01, 0.08, 0.005 ); ?><?php $this->render_number_field( $settings, 'brush_padding_ratio', __( 'Selection padding ratio', 'relikes' ), 0.1, 0.6, 0.01 ); ?>
